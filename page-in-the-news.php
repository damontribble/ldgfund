...
<?php get_header(); ?>
    ...
    <div class="content-main">
        ...
        $myPosts->query('post_type=news-item&nopaging=true');
        while ($myPosts->have_posts()) : $myPosts->the_post();
            ?>
            <div class="news-item-entry">
                <p><?php the_date('F j, Y'); ?>
                    <br><em><?php echo get_post_meta($post->ID, 'newsItemPublication', TRUE); ?></em><br/><strong><?php the_title(); ?></strong>
                </p>
                <p><?php echo get_the_content(); ?>
                    <br><span class="file">
<strong><a href="<?php echo get_post_meta($post->ID, 'newsItemLink', TRUE); ?>" target="_blank">

        <?php echo get_post_meta($post->ID, 'newsItemLinkText', TRUE); ?></a></strong>
</span>
                </p>
            </div>
        <?php endwhile;
